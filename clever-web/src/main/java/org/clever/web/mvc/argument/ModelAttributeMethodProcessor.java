...
import org.clever.web.mvc.bind.WebRequestDataBinder;
 ...
 * 一旦创建属性通过数据绑定填充到 Servlet 请求参数。如果参数用 {@link Valid} 注释，则可以应用验证。
 * 或 {@link Validated}。
 *
...
public class ModelAttributeMethodProcessor implements HandlerMethodArgumentResolver {
    ...
    /**
     * 如果适用，验证模型属性。
     * <p>默认实现检查 {@link Valid}、{@link Validated} 和名称以“Valid”开头的自定义注释。
     *
    ...
    private static class FieldAwareConstructorParameter extends MethodParameter {
        ...
        @Override
        public Annotation @NotNull [] getParameterAnnotations() {
