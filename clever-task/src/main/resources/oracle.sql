...
(
    ...
    namespace               varchar2(63)                                    not null,
    instance_name           varchar2(127)                                   not null,
    last_heartbeat_time     timestamp(6)                                    not null,
    heartbeat_interval      number(19)      default 3000                    not null,
...
(
    ...
    max_reentry             number(10)      default 0                       not null,
    allow_concurrent        number(10)      default 1                       not null,
    max_retry_count         number(10)      default 0                       not null,
    route_strategy          number(10)      default 0                       not null,
    first_scheduler         varchar2(2047),
    whitelist_scheduler     varchar2(2047),
    blacklist_scheduler     varchar2(2047),
    load_balance            number(10)      default 1                       not null,
    is_update_data          number(10)      default 1                       not null,
    job_data                clob,
    run_count               number(19)      default 0                       not null,
    disable                 number(10)      default 0                       not null,
    description             varchar2(511),
    create_at               timestamp(6)    default CURRENT_TIMESTAMP(3)    not null,
    update_at               timestamp(6),
    primary key (id)
...
(
    ...
    namespace           varchar2(63)                                    not null,
    job_id              number(19)                                      not null,
    is_static           number(10)      default 1                       not null,
    class_name          varchar2(255)                                   not null,
    class_method        varchar2(63)                                    not null,
    create_at           timestamp(6)    default CURRENT_TIMESTAMP(3)    not null,
    update_at           timestamp(6),
    primary key (id)
);
...
(
    ...
    job_id              number(19)                                      not null,
    content             clob,
    read_only           number(10)      default 0                       not null,
    create_at           timestamp(6)    default CURRENT_TIMESTAMP(3)    not null,
    update_at           timestamp(6),
    primary key (id)
);
...
(
    ...
    namespace           varchar2(63)                                    not null,
    job_id              number(19)                                      not null,
    shell_type          varchar2(15)                                    not null,
    shell_charset       varchar2(15),
    shell_timeout       number(10)      default 600                     not null,
    content             clob,
    read_only           number(10)      default 0                       not null,
    create_at           timestamp(6)    default CURRENT_TIMESTAMP(3)    not null,
    update_at           timestamp(6),
...
(
    ...
    misfire_strategy    number(10)      default 2                       not null,
    allow_concurrent    number(10)      default 0                       not null,
    type                number(10)                                      not null,
    cron                varchar2(511),
    fixed_interval      number(19),
    fire_count          number(19)      default 0                       not null,
    disable             number(10)      default 0                       not null,
    description         varchar2(511),
    create_at           timestamp(6)    default CURRENT_TIMESTAMP(3)    not null,
    update_at           timestamp(6),
...
(
    id                  number(19)                                      not null,
    namespace           varchar2(63)                                    not null,
    instance_name       varchar2(127),
    cmd_info            varchar2(2047)                                  not null,
...
(
    ...
    namespace           varchar2(63)                                    not null,
    instance_name       varchar2(127)                                   not null,
    event_name          varchar2(63)                                    not null,
    log_data            clob,
    create_at           timestamp(6)    default CURRENT_TIMESTAMP(3)    not null,
    primary key (id)
);
...
(
    ...
    namespace           varchar2(63)                                    not null,
    instance_name       varchar2(127)                                   not null,
    job_trigger_id      number(19),
    job_id              number(19)                                      not null,
    trigger_name        varchar2(127)                                   not null,
    fire_time           timestamp(6)                                    not null,
    is_manual           number(10)                                      not null,
    trigger_time        number(10)                                      not null,
    last_fire_time      timestamp(6),
    next_fire_time      timestamp(6),
    fire_count          number(19)                                      not null,
    mis_fired           number(10)                                      not null,
    trigger_msg         varchar2(511),
    create_at           timestamp(6)    default CURRENT_TIMESTAMP(3)    not null,
    primary key (id)
);
...
(
    ...
    namespace           varchar2(63)                                    not null,
    instance_name       varchar2(127)                                   not null,
    job_trigger_log_id  number(19)                                      not null,
    job_trigger_id      number(19),
    job_id              number(19)                                      not null,
    fire_time           timestamp(6)                                    not null,
    start_time          timestamp(6)                                    not null,
    ...
    exception_info      varchar2(2047),
    run_count           number(19)                                      not null,
    before_job_data     clob,
    after_job_data      clob,
    primary key (id)
);
...
(
    id                  number(19)                                      not null,
    namespace           varchar2(63)                                    not null,
    report_time         varchar2(31)                                    not null,
    job_count           number(19)                                      not null,
    job_err_count       number(19)                                      not null,
    trigger_count       number(19)                                      not null,
    misfire_count       number(19)                                      not null,
    primary key (id)
);
