...
(
    ...
    max_reentry             number(11)      default 0                       not null,
    allow_concurrent        number(11)      default 1                       not null,
    max_retry_count         number(11)      default 0                       not null,
    route_strategy          number(11)      default 0                       not null,
    first_scheduler         varchar2(2047),
    whitelist_scheduler     varchar2(2047),
    blacklist_scheduler     varchar2(2047),
    load_balance            number(11)      default 1                       not null,
    is_update_data          number(11)      default 1                       not null,
    job_data                clob,
    run_count               number(19)      default 0                       not null,
    disable                 number(11)      default 0                       not null,
    description             varchar2(511),
    create_at               timestamp(6)    default CURRENT_TIMESTAMP(3)    not null,
    update_at               timestamp(6),
    primary key (id)
...
(
    ...
    namespace           varchar2(63)                                    not null,
    job_id              number(19)                                      not null,
    is_static           number(11)      default 1                       not null,
...
(
    ...
    job_id              number(19)                                      not null,
    content             clob,
    read_only           number(11)      default 0                       not null,
    create_at           timestamp(6)    default CURRENT_TIMESTAMP(3)    not null,
    update_at           timestamp(6),
    primary key (id)
);
...
(
    ...
    shell_timeout       number(11)      default 600                     not null,
    content             clob,
    read_only           number(11)      default 0                       not null,
    create_at           timestamp(6)    default CURRENT_TIMESTAMP(3)    not null,
    update_at           timestamp(6),
...
(
    ...
    misfire_strategy    number(11)      default 2                       not null,
    allow_concurrent    number(11)      default 0                       not null,
    type                number(11)                                      not null,
    cron                varchar2(511),
...
(
    ...
    is_manual           number(11)                                      not null,
    trigger_time        number(11)                                      not null,
    last_fire_time      timestamp(6),
    next_fire_time      timestamp(6),
    fire_count          number(19)                                      not null,
    mis_fired           number(11)                                      not null,
