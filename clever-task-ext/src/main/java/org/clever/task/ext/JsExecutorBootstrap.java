...
import org.clever.task.ext.job.JsExecutor;
...
public class JsExecutorBootstrap {
    ...
    public static JsExecutorBootstrap create(SchedulerConfig schedulerConfig, Environment environment) {
        ...
        logs.add("      maxWait                  : " + StrFormatter.toPlainString(enginePool.getMaxWait()));
        ...
        logs.add("      timeBetweenEvictionRuns  : " + StrFormatter.toPlainString(enginePool.getTimeBetweenEvictionRuns()));
        logs.add("      numTestsPerEvictionRun   : " + enginePool.getNumTestsPerEvictionRun());
        logs.add("      minEvictableIdleTime     : " + StrFormatter.toPlainString(enginePool.getMinEvictableIdleTime()));
        logs.add("      softMinEvictableIdleTime : " + StrFormatter.toPlainString(enginePool.getSoftMinEvictableIdleTime()));
        logs.add("      evictionPolicyClassName  : " + enginePool.getEvictionPolicyClassName());
        logs.add("      evictorShutdownTimeout   : " + StrFormatter.toPlainString(enginePool.getEvictorShutdownTimeout()));
