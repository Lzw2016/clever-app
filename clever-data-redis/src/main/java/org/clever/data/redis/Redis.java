...
//        this.jacksonMapper = new JacksonMapper(lettuceClientBuilder.getObjectMapper());
//        initCheck();
//    }
//
//    /**
...
//     * @param objectMapper       JSON序列化反序列化对象
//     */
//    public Redis(RedisProperties properties, List<LettuceClientConfigurationBuilderCustomizer> builderCustomizers, ObjectMapper objectMapper) {
...
//     * @param objectMapper      JSON序列化反序列化对象
//     */
//    public Redis(RedisProperties properties, LettuceClientConfigurationBuilderCustomizer builderCustomizer, ObjectMapper objectMapper) {
...
//     * @param objectMapper           JSON序列化反序列化对象
//     */
//    public Redis(RedisConnectionFactory redisConnectionFactory, ObjectMapper objectMapper) {
...
//     * @param dateStr 过期时间
//     */
//    public Boolean kExpireAt(String key, Object dateStr) {
