...
//import org.clever.security.model.event.AuthorizationFailureEvent;
//import org.clever.security.model.event.AuthorizationSuccessEvent;
...
//                log.debug("### 授权通过 | PassWeight={} | Weight={} | Voter={}", passWeight, authorizationVoter.getWeight(), authorizationVoter.getClass().getSimpleName());
//            } else if (Objects.equals(VoterResult.REJECT.getId(), voterResult.getId())) {
//                // 驳回
//                passWeight = passWeight - authorizationVoter.getWeight();
//                log.debug("### 授权驳回 | PassWeight={} | Weight={} | Voter={}", passWeight, authorizationVoter.getWeight(), authorizationVoter.getClass().getSimpleName());
//            } else if (Objects.equals(VoterResult.ABSTAIN.getId(), voterResult.getId())) {
//                // 弃权
//                log.debug("### 放弃授权 | PassWeight={} | Weight={} | Voter={}", passWeight, authorizationVoter.getWeight(), authorizationVoter.getClass().getSimpleName());
//            } else {
