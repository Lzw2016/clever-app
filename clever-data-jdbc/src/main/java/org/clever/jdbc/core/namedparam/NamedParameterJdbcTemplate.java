 ...
 * 它还允许将值{@link List}扩展到适当数量的占位符。
 *
 * <p>底层{@link JdbcTemplate}是公开的，允许方便地访问传统的{@link JdbcTemplate}方法。
 *
...
public class NamedParameterJdbcTemplate implements NamedParameterJdbcOperations {
     ...
     * <p>创建一个经典的{@link JdbcTemplate}并包装它。
     *
    ...
    /**
     * 为给定的经典{@link JdbcTemplate}创建一个新的NamedParameterJdbcTemplate。
     *
