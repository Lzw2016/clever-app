...
import org.clever.data.jdbc.support.entity.AutoIncrementId;
...
public class QAutoIncrementId extends RelationalPathBase<AutoIncrementId> {
    ...
    public QAutoIncrementId(String variable) {
        super(AutoIncrementId.class, forVariable(variable), "", "auto_increment_id");
        addMetadata();
    }
    ...
    public QAutoIncrementId(Path<? extends AutoIncrementId> path) {
        super(path.getType(), path.getMetadata(), "", "auto_increment_id");
        addMetadata();
    }

    public QAutoIncrementId(PathMetadata metadata) {
        super(AutoIncrementId.class, metadata, "", "auto_increment_id");
        addMetadata();
    }
