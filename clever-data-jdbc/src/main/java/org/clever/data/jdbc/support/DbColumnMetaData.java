...
public class DbColumnMetaData {
    ...
    /**
     * 数据库名，优先取 {@link ResultSetMetaData#getSchemaName(int)} 不存在就取 {@link ResultSetMetaData#getCatalogName(int)}
     */
    ...
    // /** 字段扩展信息 */
    // private LinkedHashMap<String, Object> ext = new LinkedHashMap<>();
}
