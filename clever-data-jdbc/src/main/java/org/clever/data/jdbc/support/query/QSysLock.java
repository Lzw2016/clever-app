...
import org.clever.data.jdbc.support.entity.SysLock;
...
public class QSysLock extends RelationalPathBase<SysLock> {
    ...
    public QSysLock(String variable) {
        super(SysLock.class, forVariable(variable), "", "sys_lock");
        addMetadata();
    }
    ...
    public QSysLock(Path<? extends SysLock> path) {
        super(path.getType(), path.getMetadata(), "", "sys_lock");
        addMetadata();
    }

    public QSysLock(PathMetadata metadata) {
        super(SysLock.class, metadata, "", "sys_lock");
        addMetadata();
    }
