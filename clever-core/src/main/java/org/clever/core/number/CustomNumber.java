...
//            '`', '{', '|', '}', '~',
    ...
    public static long toNumber(String s, int radix) {
        ...
        if (radix < MIN_RADIX) {
            throw new NumberFormatException("radix " + radix + " less than CustomNumber.MIN_RADIX");
        }
        if (radix > MAX_RADIX) {
            throw new NumberFormatException("radix " + radix + " greater than CustomNumber.MAX_RADIX");
        }
