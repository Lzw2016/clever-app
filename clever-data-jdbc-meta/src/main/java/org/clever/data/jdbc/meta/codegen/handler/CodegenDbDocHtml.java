 ...
 */
public class CodegenDbDocHtml extends AbstractCodegenHandler {
    @Override
    public Template getTemplate(Engine engine) {
        return engine.getTemplate("template/enjoy/db_doc_html.txt");
    }
    ...
    public String getFileName(TemplateDataContext context) {
        ...
        return String.format("%s(%s).html", fileName, context.getSchema().getName());
    }
