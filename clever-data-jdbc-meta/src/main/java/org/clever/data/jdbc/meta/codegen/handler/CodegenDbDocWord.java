 ...
 */
public class CodegenDbDocWord extends AbstractCodegenHandler {
    @Override
    public Template getTemplate(Engine engine) {
        return engine.getTemplate("template/enjoy/db_doc_word.txt");
    }
    ...
    public String getFileName(TemplateDataContext context) {
        ...
        return String.format("%s(%s).doc", fileName, context.getSchema().getName());
    }
