...
import org.clever.model.entity.BizCode;
...
public class QBizCode extends RelationalPathBase<BizCode> {
    ...
    public QBizCode(String variable) {
        super(BizCode.class, forVariable(variable), "test", "biz_code");
        addMetadata();
    }
    ...
    public QBizCode(Path<? extends BizCode> path) {
        super(path.getType(), path.getMetadata(), "test", "biz_code");
        addMetadata();
    }

    public QBizCode(PathMetadata metadata) {
        super(BizCode.class, metadata, "test", "biz_code");
        addMetadata();
    }
