...
import org.clever.boot.system.ApplicationHome;
...
public class StartupInfoLogger {
    ...
    public void logStarting(Logger applicationLog) {
        ...
        //     applicationLog.debug(String.valueOf(this.getRunningMessage()));
        // }
    }
    ...
    private CharSequence getRunningMessage() {
        StringBuilder message = new StringBuilder();
        message.append("Running with Clever Boot");
        appendVersion(message, getClass());
        message.append(", Clever");
        appendVersion(message, AppContext.class);
        return message;
    }
