...
/**
 * 在 {@link Color AWT 颜色} 上下文中使用 {@link AnsiColor} 的实用程序
 * <p>
 * 作者：lizw <br/>
...
public final class AnsiColors {
    ...
    /**
     * 创建一个具有指定位深度的新 {@link AnsiColors} 实例。
     *
    ...
    /**
     * 找到最接近给定 {@link AnsiElement AWT 颜色}的 ANSI {@link Color}
     *
     * @param color AWT 颜色
     * @return 最接近的 ANSI 颜色
     */
    ...
    private static final class LabColor {
        ...
        double getDistance(LabColor other) {
            ...
            return Math.sqrt(Math.max(
                    0.0, Math.pow((this.l - other.l), 2) + Math.pow(deltaC / (1 + 0.045 * c1), 2) + Math.pow(deltaH / (1 + 0.015 * c1), 2.0)
            ));
        }
    }
