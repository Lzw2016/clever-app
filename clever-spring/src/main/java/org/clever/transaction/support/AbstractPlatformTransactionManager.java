...
public abstract class AbstractPlatformTransactionManager implements PlatformTransactionManager, Serializable {
     ...
     * @see org.clever.transaction.TransactionDefinition#PROPAGATION_NOT_SUPPORTED
     * @see org.clever.transaction.TransactionDefinition#PROPAGATION_NEVER
     */
    public static final int SYNCHRONIZATION_ALWAYS = 0;
    /**
     * 仅为实际事务激活事务同步，也就是说，不为因没有现有后端事务的PROPAGATION_SUPPORTS而导致的空事务激活事务同步。
     *
     * @see org.clever.transaction.TransactionDefinition#PROPAGATION_REQUIRED
     * @see org.clever.transaction.TransactionDefinition#PROPAGATION_MANDATORY
     * @see org.clever.transaction.TransactionDefinition#PROPAGATION_REQUIRES_NEW
     */
     ...
     *
     * @see org.clever.transaction.TransactionDefinition#TIMEOUT_DEFAULT
     */
     ...
     *
     * @see org.clever.transaction.UnexpectedRollbackException
     */
     ...
     * @return 要使用的实际超时
     * @see org.clever.transaction.TransactionDefinition#getTimeout()
     ...
     *
     * @see org.clever.transaction.TransactionStatus#isRollbackOnly()
     * @see #doCommit
     * @see #rollback
     */
    @Override
     ...
     *
     * @return 当前事务对象
     * @throws org.clever.transaction.CannotCreateTransactionException 如果事务支持不可用
     ...
     * @throws org.clever.transaction.NestedTransactionNotSupportedException 如果基础事务不支持嵌套
     */
     ...
     * @throws org.clever.transaction.TransactionSuspensionNotSupportedException 如果事务管理器实现不支持挂起
     * @throws TransactionException                                              如果出现系统错误
     * @see #doResume
     */
     ...
     * @throws org.clever.transaction.TransactionSuspensionNotSupportedException 如果事务管理器实现不支持恢复
     * @throws TransactionException                                              如果出现系统错误
     * @see #doSuspend
     */
     ...
     * @see org.clever.transaction.TransactionStatus#setRollbackOnly()
     * @see org.clever.transaction.UnexpectedRollbackException
     */
