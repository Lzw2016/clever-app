...
public abstract class JdbcUtils {
     ...
     * <p>使用特定类型的ResultSet访问器方法，对于未知类型，返回到{@link #getResultSetValue(java.sql.ResultSet, int)}。
     ...
     * @return 中对应的常量名称 {@link java.sql.Types} (例如 "VARCHAR"/"NUMERIC"), 或 {@code null} 如果无法解决
     */
