 ...
 *
 * <p>实现可以是通用的(例如，使用用于JDBC的{@link java.sql.SQLException#getSQLState() SQLState}代码)，
 * 也可以是完全专有的(例如，使用Oracle错误代码)，以获得更高的精度。
 * <p>
 * 作者：lizw <br/>
 * 创建时间：2022/06/27 21:42 <br/>
 *
 * @see org.clever.dao.DataAccessException
 */
@FunctionalInterface
public interface SQLExceptionTranslator {
     ...
     * @see org.clever.dao.DataAccessException#getRootCause()
     */
