...
/**
 * 与特定数据库关联的自定义{@link org.clever.jdbc.support.SQLExceptionTranslator}实例的注册表，
...
public final class CustomSQLExceptionTranslatorRegistry {
    ...
    /**
     * Map注册表以保存自定义转换器特定的数据库。Key是中定义的数据库产品名称 {@link org.clever.jdbc.support.SQLErrorCodesFactory}.
     */
