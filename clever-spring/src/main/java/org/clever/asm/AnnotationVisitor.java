...
public abstract class AnnotationVisitor {
     ...
     *
     * @param api the ASM API version implemented by this visitor. Must be one of the {@code ASM}<i>x</i> values in {@link Opcodes}.
     */
     ...
     *
     * @param api               the ASM API version implemented by this visitor. Must be one of the {@code ASM}<i>x</i> values in {@link Opcodes}.
     * @param annotationVisitor the annotation visitor to which this visitor must delegate method calls. May be {@literal null}.
     */
     ...
     *              {@link String} or {@link Type} of {@link Type#OBJECT} or {@link Type#ARRAY} sort.
     *              This value can also be an array of byte, boolean, short, char, int, long, float or double values
     *              (this is equivalent to using {@link #visitArray} and visiting each array element in turn, but is more convenient).
     */
     ...
     * or {@literal null} if this visitor is not interested in visiting this nested annotation.
     * <i>The nested annotation value must be fully visited before calling other methods on this annotation visitor</i>.
     */
     ...
     * or {@literal null} if this visitor is not interested in visiting these values.
     * The 'name' parameters passed to the methods of this visitor are ignored.
