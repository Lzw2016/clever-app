...
final class AnnotationWriter extends AnnotationVisitor {
     ...
     * @param useNamedValues     whether values are named or not. AnnotationDefault and annotation arrays use unnamed values.
     * @param annotation         where the 'annotation' or 'type_annotation' JVMS structure corresponding to the visited content must be stored.
     *                           This ByteVector must already contain all the fields of the structure except the last one (the element_value_pairs array).
     * @param previousAnnotation the previously visited annotation of the Runtime[In]Visible[Type]Annotations attribute to which this annotation belongs,
     *                           or {@literal null} in other cases (e.g. nested or array annotations).
     */
    AnnotationWriter(
