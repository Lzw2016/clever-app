...
public final class Type {
     ...
     * packed into a single int i = {@code (argumentsSize &lt;&lt; 2) | returnSize}
     * (argumentsSize is therefore equal to {@code i &gt;&gt; 2}, and returnSize to {@code i &amp; 0x03}).
     */
     ...
     * method types.
     *
     * @param opcode a JVM instruction opcode. This opcode must be one of ILOAD, ISTORE, IALOAD, IASTORE,
     *               IADD, ISUB, IMUL, IDIV, IREM, INEG, ISHL, ISHR, IUSHR, IAND, IOR, IXOR and IRETURN.
     * @return an opcode that is similar to the given opcode, but adapted to this {@link Type}.
     * For example, if this type is {@code float} and {@code opcode} is IRETURN, this method returns FRETURN.
     */
