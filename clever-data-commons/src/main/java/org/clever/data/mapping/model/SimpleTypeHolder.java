package org.clever.data.mapping.model;
...
public class SimpleTypeHolder {
    ...
    /**
     * 创建一个新的 {@link SimpleTypeHolder} 来承载给定的自定义简单类型。
     * 可以通过为 {@literal registerDefaults} 传递 { false} 来停用默认简单类型的注册@code。
     */
    ...
    /**
     * 复制构造函数以创建一个新的 {@link SimpleTypeHolder}，该 SimpleTypeHolder 带有给定的其他自定义简单类型
     *
     * @param customSimpleTypes 不能为 {@literal null}
